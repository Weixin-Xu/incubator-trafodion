        ...
        SQLINTEGER	datetimeIntervalPrecision)
{
    ...
    switch (targetDescPtr->m_ODBCDataType)
    {
        ...
        case SQL_DOUBLE:
        case SQL_DECIMAL:
        retCode = ConvertNumToNumSimple(CDataType,
                srcDataPtr,
                srcLength,
                targetDescPtr,
                iconv,
        ...
        break;
        case SQL_NUMERIC:
        retCode = ConvertAnyToNumeric(ODBCAppVersion,
                CDataType,
                srcDataPtr,
                srcLength,
                targetDescPtr,
        ...
        case SQL_DATE:
        case SQL_TYPE_DATE:
        retCode = ConvertAnyToDateType(ODBCAppVersion,
                CDataType,
                srcDataPtr,
                srcLength,
                targetDescPtr,
        ...
        case SQL_TIME:
        case SQL_TYPE_TIME:
        retCode = ConvertAnyToTimeType(ODBCAppVersion,
                CDataType,
                srcDataPtr,
                srcLength,
                targetDescPtr,
        ...
        retCode = ConvertAnyToTimeStampType(ODBCAppVersion,
                CDataType,
                srcDataPtr,
                srcLength,
                targetDescPtr,
        ...
        retCode = ConvertAnyToTimeIntervalType(ODBCAppVersion,
                CDataType,
                srcDataPtr,
                srcLength,
                targetDescPtr,
...
unsigned long  ODBC::ConvertAnyToNumeric(SQLINTEGER    ODBCAppVersion,
        SQLSMALLINT   CDataType,
        SQLPOINTER    srcDataPtr,
        SQLINTEGER    srcLength,
        CDescRec*     targetDescPtr,
...
SQLRETURN ODBC::MemNumToNum(SQLPOINTER  DataPtr,
            SQLINTEGER &    DataLen,
            CDescRec*       targetDescPtr,
            SQLSMALLINT     CDataType,
            BOOL            useDouble,
...
unsigned long  ODBC::ConvertNumToNumSimple(SQLSMALLINT   CDataType,
        SQLPOINTER    srcDataPtr,
        SQLINTEGER    srcLength,
        CDescRec*     targetDescPtr,
        ICUConverter* iconv,
...
SQLRETURN ODBC::ConvertCharset(SQLPOINTER  DataPtr,
            SQLINTEGER &    DataLen,
            CDescRec*       targetDescPtr,
            SQLSMALLINT     CDataType,
            ICUConverter*   iconv,
...
unsigned long  ODBC::ConvertAnyTypeToCharsSimple(SQLINTEGER    ODBCAppVersion,
                          SQLSMALLINT   CDataType,
                          SQLPOINTER    srcDataPtr,
                          SQLINTEGER    srcLength,
                          CDescRec*     targetDescPtr,
...
unsigned long  ODBC::ConvertAnyToDateType(SQLINTEGER       ODBCAppVersion,
        SQLSMALLINT   CDataType,
        SQLPOINTER    srcDataPtr,
        SQLINTEGER    srcLength,
        CDescRec*     targetDescPtr,
...
unsigned long  ODBC::ConvertAnyToTimeType(SQLINTEGER       ODBCAppVersion,
        SQLSMALLINT   CDataType,
        SQLPOINTER    srcDataPtr,
        SQLINTEGER    srcLength,
        CDescRec*     targetDescPtr,
...
unsigned long  ODBC::ConvertAnyToTimeStampType(SQLINTEGER      ODBCAppVersion,
        SQLSMALLINT   CDataType,
        SQLPOINTER    srcDataPtr,
        SQLINTEGER    srcLength,
        CDescRec*     targetDescPtr,
...
SQLRETURN ODBC::DataTypeTransform(SQLSMALLINT  & cTmpDataType,SQLSMALLINT  CDataType,SQLSMALLINT ODBCDataType)
{
    if (CDataType == SQL_C_DEFAULT)
    {
        switch (ODBCDataType)
...
SQLRETURN ODBC::TmpBufferFitting(SQLSMALLINT ODBCDataType,SQLSMALLINT CDataType,SQLPOINTER    srcDataPtr,CHAR * cTmpBuf)
{
...
unsigned long  ODBC::ConvertAnyToTimeIntervalType(SQLINTEGER       ODBCAppVersion,
        SQLSMALLINT   CDataType,
        SQLPOINTER    srcDataPtr,
        SQLINTEGER    srcLength,
        CDescRec*     targetDescPtr,
...

{
    ...
    retCode = DataTypeTransform(cTmpDataType,CDataType,ODBCDataType);
    if(retCode != SQL_SUCCESS)
        return retCode;
    switch (cTmpDataType)
    {
    ...
    if(runFunc)
        retCode =  TmpBufferFitting(ODBCDataType,cTmpDataType,srcDataPtr,cTmpBuf);
    if(retCode != SQL_SUCCESS)
        return retCode;
